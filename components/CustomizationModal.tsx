...
const DifficultyOption: React.FC<{ 
    ...
    return (
        <button 
            ...
            className={`w-full py-4 border-2 rounded-xl font-bold transition-all duration-200 ease-in-out text-center text-sm shadow-sm
            ${isChecked 
...
export const CustomizationModal: React.FC<CustomizationModalProps> = ({ settings, onSave, onClose }) => {
  ...
  return (
    <Modal show={true} onClose={onClose}>
      <div className="w-full sm:w-[32rem] max-w-lg mx-auto flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto min-h-0 pb-2">
             <div className="grid grid-cols-1 gap-8 text-left">
                <div className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="displayName" className="block text-lg font-bold mb-3 text-slate-200">Nickname</label>
                        <input 
                            id="displayName"
                            type="text" 
                            value={displayName}
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <label className="block text-lg font-bold mb-3 text-slate-200">Difficulty</label>
                        ...
                        <div className="mt-4 p-4 bg-slate-800/50 rounded-xl border border-slate-700 text-sm text-slate-300 leading-relaxed min-h-[5rem]">
